...
@endsection
@section('content')
<div class="text-xl mx-5">Annual Reports</div>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $orderA->year }}</td>
                    <td>
                        <a href="{{ route('reports.sofp', ['year' => $orderA->year]) }}"
                            class="btn btn-sm btn-primary">View</a>
                        <a href="{{ route('reports.sofp-download', ['year' => $orderA->year]) }}"
...
<div class="text-xl mx-5">Monthly Reports</div>
<div class="card product-list">
    <div class="card-body">
        <table class="table table-bordered table-hover">
            <thead class="thead-dark">
